...
async function gerarPDF_DS160(data) {
  return new Promise((resolve, reject) => {
    ...
    // ... (conteúdo completo do PDF DS-160 - mantido igual ao seu código)
    // Para economia de espaço, mantive apenas a estrutura, mas o código completo está no seu arquivo
  ...
  try {
    ...
    if (state.currentMenu === 'submenu') {
      ...
      if (['1', '2', '3', '4', '5', '6'].includes(messageText)) {
        ...
        // ============================================================
        //  OPÇÃO 6: AVALIAÇÃO GRATUITA - Links específicos por país
        // ============================================================
          ...
          const link = linksAvaliacao[service] || 'https://getvisa.com.br/simulador-visto-americano';
          const nomeServico = nomesServicos[service] || 'SERVIÇO';
          
          resposta = 
            `📊 *ANÁLISE GRATUITA DE PERFIL - ${nomeServico}*\n\n` +
