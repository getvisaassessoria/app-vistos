...
app.post('/api/webhook/zapi', async (req, res) => {
    ...
    (async () => {
        try {
            ...
            // ============================================================
            // 4. VERIFICAR SE É NOVO (JÁ CADASTRADO)
            // ============================================================
            ...
            // ============================================================
            // 5. NOVO CLIENTE - CADASTRAR E ENVIAR MENU
            // ============================================================
            ...
            // ✅ CORREÇÃO: Usar cadastrarCliente com UPSERT
            ...
            console.log(`✅ Cliente ${cleanPhone} cadastrado/atualizado com sucesso!`);
...
async function gerarPDF_DS160(data) {
    return new Promise((resolve, reject) => {
        ...
        // [TODAS AS SEÇÕES DO PDF DS-160]
        // (o código é muito extenso, mas você pode copiar do seu arquivo original)
        // INFORMACOES INICIAIS, PESSOAIS, VIAGEM, PAGADOR, ACOMPANHANTES, etc.
